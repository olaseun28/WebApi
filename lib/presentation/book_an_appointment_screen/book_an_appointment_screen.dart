...
import 'package:care__support/widgets/app_bar/appbar_leading_image.dart';
import 'package:care__support/widgets/app_bar/appbar_subtitle.dart';
...
class BookAnAppointmentScreen extends GetWidget<BookAnAppointmentController> {
  ...
  Widget _buildReason() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      _buildConsultation(consultation: "lbl_reason".tr, price: "lbl_change".tr),
      SizedBox(height: 6.v),
      Row(children: [
        CustomIconButton(
            height: 36.adaptSize,
  ...
  Widget _buildPaymentDetails() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      SizedBox(height: 11.v),
      _buildConsultation(consultation: "lbl_total".tr, price: "lbl_61_00".tr)
    ]);
  }
  ...
  Widget _buildPaymentMethod() {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      SizedBox(height: 10.v),
      _buildConsultation(consultation: "lbl_visa".tr, price: "lbl_change".tr)
    ]);
  }
